...
public class InsFunc extends Instruccion {
    ...
    public String toString(){
        ...
        return ("LLamadaFuncion(Nombre: " + func + ", Params: (" + param + ")");
    }
    ...
    public void chequea(){
        ...
        for(int i = 0; i < referencias.size() && !find; ++i){
            if(referencias.get(i).tipo.tipo.id.equals("void") && referencias.get(i).parametros.size() == this.parametros.size()){
